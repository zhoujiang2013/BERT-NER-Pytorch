...
def parse_common(parser):
    ...
    parser.add_argument("--task_name", default=None, type=str, required=True,
                        help="The name of the task to train selected in the list: ['cner', 'cluener'].")
    ...
    parser.add_argument("--per_train_batch_size", default=8, type=int,
                        help="Batch size per GPU/CPU for training.")
    parser.add_argument("--per_eval_batch_size", default=8, type=int,
...
def get_argparse():
    ...
    parser = parse_common(parser)
    parser = parse_other(parser)
    return parser
